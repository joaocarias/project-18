                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select id="genero" type="text" class="form-control @error('genero') is-invalid @enderror" name="genero">
                                            ...
                                            <option value="MASCULINO" @if ( old('genero', $model->genero ?? '' ) == 'MASCULINO' ) {{ 'selected' }} @endif>{{ __('MASCULINO') }}</option>
                                            <option value="FEMININO" @if ( old('genero', $model->genero ?? '' ) == 'FEMININO' ) {{ 'selected' }} @endif>{{ __('FEMININO') }}</option>
                                        </select>
                                    </div>
